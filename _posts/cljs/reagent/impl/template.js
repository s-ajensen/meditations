...
var G__14030 = o;
goog.object.set(G__14030,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__14034 = o;
goog.object.set(G__14034,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__14035__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__14035 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__14036__i < G__14036__a.length) {G__14036__a[G__14036__i] = arguments[G__14036__i + 0]; ++G__14036__i;}
  args = new cljs.core.IndexedSeq(G__14036__a,0,null);
} 
return G__14035__delegate.call(this,args);};
G__14035.cljs$lang$maxFixedArity = 0;
G__14035.cljs$lang$applyTo = (function (arglist__14037){
var args = cljs.core.seq(arglist__14037);
return G__14035__delegate(args);
});
...
var G__14038 = props;
var G__14038__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14038,cljs.core.cst$kw$id,id):G__14038);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14038__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__14039 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14039,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__14039;
}
})(),id_class);
...
var G__14040 = (cljs.core.count(argv) - first_child);
switch (G__14040) {
case (0):
...
break;
case (1):
var G__14041 = component;
var G__14042 = jsprops;
var G__14043 = reagent.impl.protocols.as_element(this$,cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__14041,G__14042,G__14043);
...
var vec__14045 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14045,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14045,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14045,(2),null);
...
var temp__5757__auto___14048 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___14048 == null)){
} else {
var key_14049 = temp__5757__auto___14048;
(jsprops.key = key_14049);
}
...
var temp__5757__auto___14052 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___14052 == null)){
} else {
var key_14053 = temp__5757__auto___14052;
(jsprops.key = key_14053);
}

var G__14050 = reagent.impl.component.functional_render_fn(compiler,tag);
var G__14051 = jsprops;
return reagent.impl.template.global$module$react.createElement(G__14050,G__14051);
});
/**
...
var temp__5757__auto___14054 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___14054 == null)){
} else {
var key_14055 = temp__5757__auto___14054;
(jsprops.key = key_14055);
}
...
var temp__5757__auto___14056 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___14056 == null)){
} else {
var key_14057 = temp__5757__auto___14056;
(jsprops.key = key_14057);
}
...
var temp__5757__auto___14058 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___14058 == null)){
} else {
var key_14059 = temp__5757__auto___14058;
(jsprops.key = key_14059);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__14060_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__14060_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__14061 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14061,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14061,(1),null);
...
break;
default:
var G__14066 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__14067 = compiler;
v = G__14066;
compiler = G__14067;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template14071 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template14071 = (function (opts,id,fn_to_element,parse_fn,meta14072){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template14071.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14073,meta14072__$1){
var self__ = this;
var _14073__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template14071(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta14072__$1));
}));

(reagent.impl.template.t_reagent$impl$template14071.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14073){
var self__ = this;
var _14073__$1 = this;
return self__.meta14072;
}));

(reagent.impl.template.t_reagent$impl$template14071.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template14071.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template14071.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template14071.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template14071.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template14071.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$opts,cljs.core.cst$sym$id,cljs.core.cst$sym$fn_DASH_to_DASH_element,cljs.core.cst$sym$parse_DASH_fn,cljs.core.cst$sym$meta14072], null);
}));

(reagent.impl.template.t_reagent$impl$template14071.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template14071.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template14071");

(reagent.impl.template.t_reagent$impl$template14071.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template14071");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template14071.
 */
reagent.impl.template.__GT_t_reagent$impl$template14071 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template14071(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta14072){
return (new reagent.impl.template.t_reagent$impl$template14071(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta14072));
});

}

return (new reagent.impl.template.t_reagent$impl$template14071(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
